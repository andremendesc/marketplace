 ...
 */
class Version20180102173229 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        , transferEnabled BOOLEAN NOT NULL, lastTransfer VARCHAR(255) DEFAULT NULL, transferInterval VARCHAR(255) DEFAULT NULL, transferDay INTEGER NOT NULL, automaticAnticipationEnabled BOOLEAN NOT NULL, anticipatableVolumePercentage INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_957A647953A23E0A FOREIGN KEY (bank_account) REFERENCES bank_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
