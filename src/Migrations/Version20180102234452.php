 ...
 */
class Version20180102234452 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__bank_account AS SELECT id, bank_code, agencia, agencia_dv, conta, conta_dv, document_number, legal_name, date_created, type, updated_at FROM bank_account');
        $this->addSql('DROP TABLE bank_account');
        $this->addSql('CREATE TABLE bank_account (id INTEGER NOT NULL, bank_code INTEGER NOT NULL, agencia INTEGER NOT NULL, agencia_dv INTEGER NOT NULL, conta INTEGER NOT NULL, conta_dv INTEGER NOT NULL, document_number INTEGER NOT NULL, legal_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, date_created DATETIME NOT NULL, type VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated_at DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO bank_account (id, bank_code, agencia, agencia_dv, conta, conta_dv, document_number, legal_name, date_created, type, updated_at) SELECT id, bank_code, agencia, agencia_dv, conta, conta_dv, document_number, legal_name, date_created, type, updated_at FROM __temp__bank_account');
        $this->addSql('DROP TABLE __temp__bank_account');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE bank_account ADD COLUMN document_type VARCHAR(255) DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX UNIQ_957A647992FC23A8');
        $this->addSql('DROP INDEX UNIQ_957A6479A0D96FBF');
        $this->addSql('DROP INDEX UNIQ_957A6479C05FB297');
        $this->addSql('DROP INDEX UNIQ_957A647953A23E0A');
